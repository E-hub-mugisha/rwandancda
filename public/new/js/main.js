...
! function (o) {
    ...
    o("#preloader").fadeOut("normall", function () {
        ...
        e <= 50 ? (o("header").removeClass("scrollHeader").addClass("fixedHeader"), t.attr("src", "new/img/logos/logo.png")) : (o("header").removeClass("fixedHeader").addClass("scrollHeader"), t.attr("src", "new/img/logos/logo.png")), a.attr("src", "new/img/logos/logo.png")
    }), s.on("scroll", function () {
        ...
        }), o(".highlight-carousel1").owlCarousel({
            loop: !0,
            responsiveClass: !0,
            autoplay: !0,
            smartSpeed: 1500,
        ...
        o(".filtering").on("click", "span", function () {
            ...
            e.stopPropagation()
        }), o(".portfolio-gallery,.portfolio-gallery-isotope").lightGallery(), s.stellar()
    })
}(jQuery);
