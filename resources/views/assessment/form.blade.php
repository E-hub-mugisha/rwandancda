    ...
    <div class="container">
        ...
        <div class="cs_section_heading cs_style_1 cs_type_1 wow fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.25s">
            <div class="cs_section_heading_left">
                <p class="cs_section_subtitle cs_fs_18 cs_semibold cs_accent_color cs_heading_font">Health Assessment</p>
                <h2 class="cs_section_title cs_accent_color mb-0">Diabetes & Hypertension <br> Risk Evaluation</h2>
            </div>
            <div class="cs_section_heading_right cs_accent_color text-end">
                Early detection empowers individuals to take preventive measures. Use this simple tool to estimate your risk and seek timely care.
            </div>
        </div>
                    ...
                    <div class="col-lg-10">
                        <div class="cs_appointment_form_wrapper cs_type_3 cs_radius_10">
                            ...
                            <div class="row justify-item-center">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="cs_form_field_wrapper cs_radius_10">
                                        <input type="number" name="weight" class="cs_form_field cs_fs_14" id="weight" placeholder="Your Weight (kg)" required>
                                        <span class="cs_input_icon position-absolute">kg</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="cs_form_field_wrapper cs_radius_10">
                                        <input type="number" name="height" class="cs_form_field cs_fs_14" id="height" placeholder="Your Height (cm)" required>
                                ...
                                <!-- Physical Activity -->
                                <div class="col-md-6 mb-3">
                                    <label for="physical_activity" class="form-label cs_white_color">Do you engage in regular physical activity?</label>
                                    <div class="cs_form_field_wrapper cs_radius_10">
                                ...
                                <!-- Hypertension -->
                                <div class="col-md-4 mb-3">
                                    <label for="hypertension" class="form-label cs_white_color">Have you been diagnosed with hypertension?</label>
                                    <div class="cs_form_field_wrapper cs_radius_10">
                                ...
                                <div class="col-md-12 mt-5 text-center">
                                    <button type="submit" class="cs_btn cs_style_1 cs_fs_18 cs_semibold cs_white_bg cs_radius_100">
                                        <span class="cs_btn_text">Assess My Risk</span>
                                    </button>
                                </div>
