                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="project-state">
                                <span class="badge badge-success">{{ $category->slug }}</span>
                            </td>
                            ...
                            <a class="btn btn-primary btn-sm" href="{{ route('categories.show', $category->id) }}">
                                ...
                                <form id="delete-form" action="{{ route('categories.destroy', $category->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Category?')"><i class="fas fa-trash">
                                        </i></button>
                                </form>
                            </td>
                        </tr>
